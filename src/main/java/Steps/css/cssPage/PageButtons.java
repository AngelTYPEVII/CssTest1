...
public class PageButtons {
    ...
    public void oneClick(){
        clickBtn.click();
        dynamicClickMessage.checkTextP("You have done a dynamic click");
    }
    @Step
    public void doubleClick(){
        doubleClickBtn.doubleClickBtn();
        doubleClickMessage.checkTextP("You have done a double click");
    }
    @Step
    public void rightClick(){
        rightClickBtn.rightClickBtn();
        rightClickMessage.checkTextP("You have done a right click");
    }
}
